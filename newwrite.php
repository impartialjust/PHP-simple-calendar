...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    echo "Date and time: " . $_POST["date"] . " " . $_POST["time"] . "<br>
Things: " . $_POST["things"] . "<br>";
    ...
    if ($accountt->num_rows > 0) {
        while ($row = $accountt->fetch_assoc()) {
            ...
            if ($date = $edate) {
                ...
                $cookiessecs = intval(substr($etime, 0, 2)) * 3600;
...
VALUES ('$account', '$time', '$date', '$things', '$length')";
    ...
    header('Location: newwrite.html');
}

?>
<br>
<p>return to <a href="newwrite.html">the sending page.</a></p>